...
# from src.summarization import summarize  # Corrected import
...
def process_pdf(file_name, file_path):
    ...
    if text:
        # Generate summary using chunking if necessary
        summary = generate_summary_for_pdf_text(text)  
        
        # Extract keywords
        keywords = extract_keywords_from_pdf_text(text)  
